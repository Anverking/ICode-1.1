/*
ICode Library:BigDecimal.h
This library implements high-precision decimal classes
and their basic operations.
*/ 

#ifndef ICODE_BIG_DECIMAL__
#define ICODE_BIG_DECIMAL__
...
{	
	...
	BigDecimal::BigDecimal(double x)
	{
		*this=x;
	}
