/*
ICode Library:arithmetic_coding.h
This library implements the basic arithmetic coding algorithm.
*/
#ifndef ICODE_ARITHMETIC_CODING__
#define ICODE_ARITHMETIC_CODING__
		...
		private:
			...
			std::vector<value_type> AdaptiveEncode(std::vector<uint8_t>src)
			{
				...
				for(auto i:src)
				{
					...
					while(LMSB==UMSB||(lower>>SSB_INDEX&1)&&((upper>>SSB_INDEX&1)==0))
					{
						if(LMSB==UMSB)
						{
