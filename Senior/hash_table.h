/*
ICode Library:hash_table.h
This library implements the hash_table class
and the basic operations of the hash table.
*/

#ifndef ICODE_HASH_TABLE__
#define ICODE_HASH_TABLE__
...
{	
	...
	template<typename __Key, typename __Value>
	hash_table<__Key, __Value>::hash_table() : m_keys(0), m_table(0)
	...
	template<typename __Key, typename __Value>
	hash_table<__Key, __Value>::hash_table(hash_table<__Key, __Value> &src) : m_keys(0), m_table(0)
		,m_is_setted(0),m_tb_size(0),m_val_count(0), m_empty(0)
	{
	...
	template<typename __Key, typename __Value>
	void
	hash_table<__Key, __Value>::clear()
	{
	...
	template<typename __Key, typename __Value>
	__Key
	hash_table<__Key, __Value>::key(__Value val)
	{
	...
	template<typename __Key, typename __Value>
	long
	hash_table<__Key,__Value>::hash_keyindex(int8_t key)
	{
	...
	template<typename __Key, typename __Value>
	long
	hash_table<__Key, __Value>::hash_keyindex(int16_t key)
	{
		u_char *p = reinterpret_cast<u_char*>(&key);
	...
	template<typename __Key, typename __Value>
	long
	hash_table<__Key, __Value>::hash_keyindex(int32_t key)
	{
		u_char *p = reinterpret_cast<u_char*>(&key);
	...
	template<typename __Key, typename __Value>
	long
	hash_table<__Key, __Value>::hash_keyindex(int64_t key)
	{
		u_char *p = reinterpret_cast<u_char*>(&key);
	...
	template<typename __Key, typename __Value>
	long
	hash_table<__Key, __Value>::hash_keyindex(uint8_t key)
	{
		u_char *p = reinterpret_cast<u_char*>(&key);
	...
	template<typename __Key, typename __Value>
	long
	hash_table<__Key, __Value>::hash_keyindex(uint16_t key)
	{
		u_char *p = reinterpret_cast<u_char*>(&key);
	...
	template<typename __Key, typename __Value>
	long
	hash_table<__Key, __Value>::hash_keyindex(uint32_t key)
	{
		u_char *p = reinterpret_cast<u_char*>(&key);
	...
	template<typename __Key, typename __Value>
	long
	hash_table<__Key, __Value>::hash_keyindex(uint64_t key)
	{
		u_char *p = reinterpret_cast<u_char*>(&key);
	...
	template<typename __Key, typename __Value>
	long
	hash_table<__Key, __Value>::hash_keyindex(float key)
	{
		u_char *p = reinterpret_cast<u_char*>(&key);
	...
	template<typename __Key, typename __Value>
	long
	hash_table<__Key, __Value>::hash_keyindex(double key)
	{
		u_char *p = reinterpret_cast<u_char*>(&key);
	...
	template<typename __Key, typename __Value>
	long
	hash_table<__Key, __Value>::hash_keyindex(std::string &key)
	{
	...
	template<typename __Key, typename __Value>
	long
	hash_table<__Key, __Value>::__hash_keyindex(u_char *first, size_t size)
	{
	...
	template<typename __Key, typename __Value>
	long
	hash_table<__Key, __Value>::__hash_null_keyindex(__Key &key, long key_index)
	{
		while(1)
		{
	...
	template<typename __Key, typename __Value>
	long
	hash_table<__Key, __Value>::__hash_keyindex_by_key(__Key &key, long key_index)
	{
		long end = key_index;
		do
		{
	...
	template<typename __Key, typename __Value>
	void
	hash_table<__Key, __Value>::reallocate(long size)
	{
		if(size > MaxKey)
		{
	...
	template<typename __Key, typename __Value>
	void
	hash_table<__Key, __Value>::need_rehash()
	{
		if(m_tb_size >= MaxKey)
		{
			return;
	...
	template<typename __Key, typename __Value>
	void
	hash_table<__Key, __Value>::rehash()
	{
	...
	template<typename __Key, typename __Value>
	void
	hash_table<__Key, __Value>::insert(__Key key, __Value val)
	{
	...
	template<typename __Key, typename __Value>
	void
	hash_table<__Key, __Value>::insert(std::pair<__Key, __Value> &key_and_val)
	{
	...
	template<typename __Key, typename __Value>
	void
	hash_table<__Key, __Value>::remove(__Key key)
	{
		...
		public std::iterator<std::input_iterator_tag, std::pair<__Key, __Value> >
	{
		...
		public:
			...
			{
				return std::pair<__Key&, __Value&>(phash->m_keys[hash_index], phash->m_table[hash_index]);
			}
