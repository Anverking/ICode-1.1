/*
ICode Library:red_black_tree.h
This library implements the red-black tree
and its basic operations.
*/

#ifndef ICODE_RED_BLAKC_TREE__
#define ICODE_RED_BLAKC_TREE__
...
#define isrc(x) ((x)!=nullptr&&(x)->ftr->rc==(x))
		protected:
			struct Node
			{
				...
				Node* rc;
				size_t s;
				Node(__Tp v=__Tp(),bool RB=true,
				     Node*f=nullptr,Node*l=nullptr,Node*r=nullptr,size_t ss=1)
	...
	typename
	red_black_tree<__Tp,__Cmp>::iterator red_black_tree<__Tp,__Cmp>::insert(__Tp v)
	{
		Node* ptn = find(v, 1);
		if(_hot == nullptr)
		{
	...
	template<typename __Tp,typename __Cmp>
	typename
	red_black_tree<__Tp,__Cmp>::Node* red_black_tree<__Tp,__Cmp>::find(__Tp v, const int op)
	{
		Node* ptn = _root;
		_hot = nullptr;
		__Cmp _cmp; 
	...
	template<typename __Tp,typename __Cmp>
	typename
	red_black_tree<__Tp,__Cmp>::Node* red_black_tree<__Tp,__Cmp>::rfind(__Tp v, const int op)
	{
		Node* ptn = _root;
		_hot = nullptr;
		__Cmp _cmp;
	...
	template<typename __Tp,typename __Cmp>
	void red_black_tree<__Tp,__Cmp>::connect34(
	...
	template<typename __Tp,typename __Cmp>
	typename
	red_black_tree<__Tp,__Cmp>::iterator red_black_tree<__Tp,__Cmp>::lower_bound(__Tp v)
	{
		Node* ptn = _root;
		__Cmp _cmp;
		while(ptn)
	...
	template<typename __Tp,typename __Cmp>
	typename
	red_black_tree<__Tp,__Cmp>::iterator red_black_tree<__Tp,__Cmp>::upper_bound(__Tp v)
	{
		Node* ptn = _root;
		__Cmp _cmp;
		while(ptn)
	...
	template<typename __Tp,typename __Cmp>
	typename
	red_black_tree<__Tp,__Cmp>::iterator red_black_tree<__Tp,__Cmp>::get_kth(int rank)
	{
	...
	template<typename __Tp,typename __Cmp>
	typename
	red_black_tree<__Tp,__Cmp>::Node* red_black_tree<__Tp,__Cmp>::findkth(int rank, Node* ptn)
	{
		if(!(ptn->lc))
		{
			if(rank == 1)
	...
	{	
		...
		if(!ptn) return 1;
		else if(_cmp(v,ptn->val) || ptn->val == v) return find_rank(v, ptn->lc);
