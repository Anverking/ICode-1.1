/*
ICode Library:fibonacci_heap.h
This library implements the class fibonacci_heap
and its basic operations. 
The Fibonacci heap is a excellent heap,
complete basic operation in a constant time
except for deleting and modifying keys.
*/

#ifndef ICODE_FIBONACCI_HEAP__
#define ICODE_FIBONACCI_HEAP__
...
namespace ICode
{ 
	template<typename __Tp,typename __Cmp = std::less<__Tp>,typename __Abs = std::less<__Tp> >
	...
	*/
	...
	struct fibonacci_heap<__Tp,__Cmp,__Abs>::Node
	{
		public:
			...
			Node(__Tp value):key(value), degree(0), marked(false),
	...
	template<typename __Tp,typename __Cmp,typename __Abs>
	typename
	fibonacci_heap<__Tp,__Cmp,__Abs>::iterator fibonacci_heap<__Tp,__Cmp,__Abs>::insert(__Tp key)
	{
		Node* node;
	...
	template<typename __Tp,typename __Cmp,typename __Abs>
	void fibonacci_heap<__Tp,__Cmp,__Abs>::combine(fibonacci_heap<__Tp,__Cmp,__Abs>* other)
	{
		if(other==nullptr)
			return;
		...
		else
		{
			...
			if (_cmp(other->min->key,this->min->key))
				this->min = other->min;
			this->keyNum += other->keyNum;
			free(other->cons);
			return;
	...
	template<typename __Tp,typename __Cmp,typename __Abs>
	typename
	fibonacci_heap<__Tp,__Cmp,__Abs>::Node* fibonacci_heap<__Tp,__Cmp,__Abs>::__pop()
	{
		Node *p = min;
	...
	void fibonacci_heap<__Tp,__Cmp,__Abs>::make_cons()
	{
		...
		cons = (Node **)realloc(cons,
		                        sizeof(fibonacci_heap<__Tp,__Cmp,__Abs> *) * (maxDegree + 1));
	}
	...
	template<typename __Tp,typename __Cmp,typename __Abs>
	typename
	fibonacci_heap<__Tp,__Cmp,__Abs>::iterator fibonacci_heap<__Tp,__Cmp,__Abs>::top()
	{
		if (min==nullptr)
			return iterator(nullptr);
		return iterator(min);
	...
	void fibonacci_heap<__Tp,__Cmp,__Abs>::renew_deg(Node *parent, int degree)
	{
		...
		if (parent-> parent != nullptr)
			renew_deg(parent->parent, degree);
	}
	...
	bool fibonacci_heap<__Tp,__Cmp,__Abs>::decrease(Node *node, __Tp key)
	{
		...
		if (_absc(node->key,key) || key==node->key)
			return false;
	...
	bool fibonacci_heap<__Tp,__Cmp,__Abs>::increase(Node *node, __Tp key)
	{
		...
		if (_absc(key,node->key) || key == node->key)
			return false;
	...
	template<typename __Tp,typename __Cmp,typename __Abs>
	typename
	fibonacci_heap<__Tp,__Cmp,__Abs>::Node* fibonacci_heap<__Tp,__Cmp,__Abs>::search(Node *root, __Tp key)
	{
		Node *t = root;
		Node *p = nullptr;
	...
	template<typename __Tp,typename __Cmp,typename __Abs>
	typename
	fibonacci_heap<__Tp,__Cmp,__Abs>::Node* fibonacci_heap<__Tp,__Cmp,__Abs>::search(__Tp key)
	{
		if (min==nullptr)
			return nullptr;
