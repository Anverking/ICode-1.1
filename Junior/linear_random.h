/*
ICode Library:linear_random.h
This library is used to generate some random numbers with better performance.
*/

#ifndef ICODE_LINEAR_RANDOM__
#define ICODE_LINEAR_RANDOM__
...
{	
	class linear_random
	{
		...
		public:
			...
			linear_random():__index(0)
			{
				memset(mt_rands,0,sizeof(0));
			}
			...
			*/
			{
				...
				{
					x=(mt_rands[i]&MASK_UPPER)+(mt_rands[(i+1)%N]&MASK_LOWER);
					xA=x>>1;
