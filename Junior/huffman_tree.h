/*
ICode Library:huffman_tree.h
This library implements the basic operation of Huffman tree and Huffman coding algorithms.
*/

#ifndef ICODE_HUFFMAN_TREE__
#define ICODE_HUFFMAN_TREE__
