/*
ICode Library:thread_pool.h
This library provides a class thread_pool 
that can store threads and based on C++11 class thread.
*/

#ifndef ICODE_THREAD_POOL__
#define ICODE_THREAD_POOL__
...
namespace ICode
{
	...
	thread_pool::thread_pool(const std::string &name):_name(name),_maxQueueSize(0),_running(false){}
