/*
ICode Library:scapegoat_tree.h
This library implements the scapegoat tree
and its basic operations.
*/

#ifndef ICODE_SCAPEGOAT_TREE__
#define ICODe_SCAPEGOAT_TREE__
...
namespace ICode
{
	...
	class scapegoat_tree
	{
		...
		public:
			...
			scapegoat_tree(const scapegoat_tree& other)
			{
				*this=other;
			}
			...
			*/
			{
				...
				if((head->cover-head->rsize)>head->cover*beta)
					rebuild(head);
