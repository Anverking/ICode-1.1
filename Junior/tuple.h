/*
ICode Library:tuple.h
This library implements the basic operation of tuple.
*/

#ifndef ICODE_TUPLE__
#define ICODE_TUPLE__
...
namespace ICode
{
	...
	class tuple<__Tp,__TList...>:public tuple<__TList...>
	{
		...
		public:
			tuple(const __Tp& v,const __TList&... tails):base_type(tails...),_value(v){}
	...
	constexpr const typename tuple_at<N,tuple<__TList...> >::value_type&
	tuple_get(const tuple<__TList...>& _tuple)
	/*
	...
	*/
	...
	template<size_t N,typename... __TList>
	typename tuple_at<N,tuple<__TList...> >::value_type&
	tuple_get(tuple<__TList...>& _tuple)
	/*
