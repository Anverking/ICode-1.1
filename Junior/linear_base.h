/*
ICode Library:linear_base.h
This library implements the structure linear base for maintaining xor sum.
*/

#ifndef ICODE_LINEAR_BASE__
#define ICODE_LINEAR_BASE__
