/*
ICode Library:random_access_set.h
This library implements random access set based on STL vector.
*/

#ifndef ICODE_RANDOM_ACCESS_SET__
#define ICODE_RANDOM_ACCESS_SET__
...
namespace ICode
{
	template<typename __Key,typename __Cmp = std::less<__Key>,typename __Alloc = std::allocator<__Key> >
	class raccess_set
	{
		private:
	...
	inline
	raccess_set<__Key, __Cmp, __Alloc>::raccess_set(
	...
	template<typename __Key,typename __Cmp,typename  __Alloc>
	inline bool
	raccess_set<__Key, __Cmp, __Alloc>::empty() const
	{
	...
	template<typename __Key,typename __Cmp,typename  __Alloc>
	inline std::pair<typename raccess_set<__Key, __Cmp, __Alloc>::const_iterator, bool>
	...
	template<typename __Key,typename __Cmp,typename  __Alloc>
	inline void
	raccess_set<__Key, __Cmp, __Alloc>::erase(
	    typename raccess_set<__Key, __Cmp, __Alloc>::iterator position
	)
	{
	...
	template<typename __Key,typename __Cmp,typename  __Alloc>
	inline void
	raccess_set<__Key, __Cmp, __Alloc>::clear()
	{
		vector_.clear();
	}
	...
	template<typename __Key,typename __Cmp,typename  __Alloc>
	inline typename raccess_set<__Key, __Cmp, __Alloc>::const_iterator
	raccess_set<__Key, __Cmp, __Alloc>::find(
	...
	template<typename __Key,typename __Cmp,typename  __Alloc>
	inline typename raccess_set<__Key, __Cmp, __Alloc>::size_type
	raccess_set<__Key, __Cmp, __Alloc>::count(
	    const key_type&  value
	) const
	{
		if(find(value) == end())
	...
	template<typename __Key,typename __Cmp,typename  __Alloc>
	inline typename raccess_set<__Key, __Cmp, __Alloc>::const_iterator
	raccess_set<__Key, __Cmp, __Alloc>::lower_bound(
	    const key_type& value
	) const
	{
	...
	template<typename __Key,typename __Cmp,typename  __Alloc>
	inline typename raccess_set<__Key, __Cmp, __Alloc>::const_iterator
	raccess_set<__Key, __Cmp, __Alloc>::upper_bound(
	    const key_type& value
	) const
	{
	...
	template<typename __Key,typename __Cmp,typename  __Alloc>
	inline std::pair<typename raccess_set<__Key, __Cmp, __Alloc>::const_iterator, typename raccess_set<__Key, __Cmp, __Alloc>::const_iterator>
	raccess_set<__Key, __Cmp, __Alloc>::equal_range(
	    const key_type& value
	) const
	{
	...
	template<typename __Key,typename __Cmp,typename  __Alloc>
	inline std::pair<typename raccess_set<__Key, __Cmp, __Alloc>::iterator, typename raccess_set<__Key, __Cmp, __Alloc>::iterator>
	raccess_set<__Key, __Cmp, __Alloc>::equal_range(
	    const key_type& value
	)
	{
