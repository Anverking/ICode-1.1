/*
ICode Library:complex.h
This library overloads the complex class
and implements some basic complex functions.
*/

#ifndef ICODE_COMPLEX__
#define ICODE_COMPLEX__
...
namespace ICode
{
	...
	class complex
	{
		...
		public:
			...
			*/
			...
			friend complex operator+(__Tp a,complex b)
			{
				return b+a;
			}
	...
	namespace complex_math
	{
		...
		*/
		{
			return (cexp(complex<__Tp>((__Tp)(NULL),x))+cexp(complex<__Tp>((__Tp)(NULL),-x)))/((__Tp)2.0);
		}
		...
		*/
		{
			return (cexp(complex<__Tp>((__Tp)(NULL),x))-cexp(complex<__Tp>((__Tp)(NULL),-x)))/(complex<__Tp>((__Tp)(NULL),(__Tp)2.0));
		}
