/*
ICode Library:leftist_tree.h
This library implements a persistent leftist tree.
Leftist tree is an excellent parallel heap.
*/
...
{	
	...
	class leftist_tree
	{
		...
		public:
			...
			leftist_tree(const leftist_tree& other)
			{
				*this=other;
			}
			...
			*/
			...
			/*
			Merge two heaps with the iterator pointer as the top of the heap and return to the top of the new heap.
			*/
			{
