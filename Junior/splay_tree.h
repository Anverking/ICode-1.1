/*
ICode Library:splay_tree.h
This library implements the splay tree and its basic operations.
*/

#ifndef ICODE_SPLAY_TREE__
#define ICODE_SPLAY_TREE__
...
namespace ICode
{
	...
	template<typename __Tp,typename __Cmp>
	struct splay_tree<__Tp,__Cmp>::iterator:public std::iterator<std::input_iterator_tag,__Tp> 
	{
		private:
			Node* _real_node;
		...
		public:
			...
			{
				return _real_node==other._real_node;
			}
			bool operator!=(iterator other)
			{
				return _real_node!=other._real_node;
	...
	template<typename __Tp,typename __Cmp>
	typename splay_tree<__Tp,__Cmp>::Node* splay_tree<__Tp,__Cmp>::search(Node* x,__Tp key) const
	{
		__Cmp _cmp;
	...
	template<typename __Tp,typename __Cmp>
	typename splay_tree<__Tp,__Cmp>::iterator splay_tree<__Tp,__Cmp>::search(__Tp key)
	{
		return iterator(search(_root,key));
	}
	
	template<typename __Tp,typename __Cmp>
	typename splay_tree<__Tp,__Cmp>::Node* splay_tree<__Tp,__Cmp>::minimum(Node* tree)
	{
		if(tree==nullptr)
			return nullptr;
	...
	template<typename __Tp,typename __Cmp>
	typename splay_tree<__Tp,__Cmp>::iterator splay_tree<__Tp,__Cmp>::upper_bound(__Tp key)
	{
	...
	template<typename __Tp,typename __Cmp>
	typename splay_tree<__Tp,__Cmp>::Node* splay_tree<__Tp,__Cmp>::maximum(Node* tree)
	{
		if(tree==nullptr)
			return nullptr;
	...
	template<typename __Tp,typename __Cmp>
	typename splay_tree<__Tp,__Cmp>::iterator splay_tree<__Tp,__Cmp>::lower_bound(__Tp key)
	{
	...
	template<typename __Tp,typename __Cmp>
	typename splay_tree<__Tp,__Cmp>::Node* splay_tree<__Tp,__Cmp>::splay(Node* tree,__Tp key)
	{
		Node N,*l,*r,*c;
	...
	template<typename __Tp,typename __Cmp>
	typename splay_tree<__Tp,__Cmp>::iterator splay_tree<__Tp,__Cmp>::splay(__Tp key)
	{
	...
	template<typename __Tp,typename __Cmp>
	typename splay_tree<__Tp,__Cmp>::Node* splay_tree<__Tp,__Cmp>::insert(Node*& tree,Node* z)
	{
	...
	template<typename __Tp,typename __Cmp>
	typename splay_tree<__Tp,__Cmp>::iterator splay_tree<__Tp,__Cmp>::insert(__Tp key)
	{
		Node* z=nullptr;
		++siz;
	...
	template<typename __Tp,typename __Cmp>
	typename splay_tree<__Tp,__Cmp>::Node* splay_tree<__Tp,__Cmp>::remove(Node*& tree,__Tp key)
	{
		Node* x;
	...
	template<typename __Tp,typename __Cmp>
	typename splay_tree<__Tp,__Cmp>::iterator splay_tree<__Tp,__Cmp>::remove(__Tp key)
	{
		--siz;
