/*
ICode Library:persistence_tree.h
This library implements the basic operation of persistent arrays.
*/

#ifndef ICODE_PERSISTENCE_TREE__
#define ICODE_PERSISTENCE_TREE__ 
		...
		public:
			...
			struct iterator
			{
				...
				public:
					const __Tp operator*()
					{
						if(_real_node==nullptr||(_real_node->lc!=nullptr&&_real_node->rc!=nullptr))
							return __Tp();
			...
			*/
			...
			/*
			Insert a node with value v to the tree with iterators pointing to nodes as roots.
			*/
			{
