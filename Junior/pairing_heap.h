/*
ICode Library:pairing_heap.h
This library implements the class pairing_heap
and its basic operations.
Pairing heap is a short-code,efficient and versatile heap.
*/

#ifndef ICODE_PAIRING_HEAP__
#define ICODE_PAIRING_HEAP__
...
namespace ICode
{
	...
	*/
	...
	struct pairing_heap<__Tp,__Cmp,__Abs>::Node
	{
		...
		Node(const __Tp& val=__Tp()):value(val),left(nullptr),child(nullptr),sibling(nullptr){}
	};
	...
	template<typename __Tp,typename __Cmp,typename __Abs>
	typename pairing_heap<__Tp,__Cmp,__Abs>::Node* pairing_heap<__Tp,__Cmp,__Abs>::merge(Node* ptr1,Node* ptr2)
	{
		if(ptr1==nullptr)
			return ptr2;
		if(ptr2==nullptr)
		...
		if(__Cmp::operator()(ptr1->value,ptr2->value))
			std::swap(ptr1,ptr2);
	...
	template<typename __Tp,typename __Cmp,typename __Abs>
	typename pairing_heap<__Tp,__Cmp,__Abs>::Node* pairing_heap<__Tp,__Cmp,__Abs>::__pop()
	{
		if(_root==nullptr)
			return nullptr;
		...
		for(Node* ptr=son1;ptr!=nullptr;ptr=ptr->sibling)
			que.push(ptr);
	...
	template<typename __Tp,typename __Cmp,typename __Abs>
	typename pairing_heap<__Tp,__Cmp,__Abs>::iterator pairing_heap<__Tp,__Cmp,__Abs>::push(const __Tp& val)
	{
		++s;
	...
	template<typename __Tp,typename __Cmp,typename __Abs>
	typename pairing_heap<__Tp,__Cmp,__Abs>::iterator pairing_heap<__Tp,__Cmp,__Abs>::pop()
	{
		if(_root==nullptr)
	...
	template<typename __Tp,typename __Cmp,typename __Abs>
	typename pairing_heap<__Tp,__Cmp,__Abs>::iterator pairing_heap<__Tp,__Cmp,__Abs>::top() const
	{
		if(_root==nullptr)
			return iterator(nullptr);
		return iterator(_root);
	...
	template<typename __Tp,typename __Cmp,typename __Abs>
	pairing_heap<__Tp,__Cmp,__Abs> pairing_heap<__Tp,__Cmp,__Abs>::combine(pairing_heap* h)
	{
	...
	{
		if(ptr==nullptr||__Cmp::operator()(val,ptr->value))
			return false;
	...
	template<typename __Tp,typename __Cmp,typename __Abs>
	bool pairing_heap<__Tp,__Cmp,__Abs>::modify(const iterator& iter,const __Tp& val)
	{
		__Abs _absc;
